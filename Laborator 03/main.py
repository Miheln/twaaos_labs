...
DATABASE = "sarcini.db"
SECRET_KEY = os.environ.get("SECRET_KEY", "dev-secret-laborator-03")
ALGORITHM = "HS256"
TOKEN_MINUTES = 30
...
app = FastAPI(title="Agenda de sarcini", version="1.0.0", lifespan=lifespan)
